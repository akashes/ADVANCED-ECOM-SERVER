...
categoryRouter.delete('/delete-category/:id',auth,authorizeRoles('ADMIN'),deleteCategoryController)
// categoryRouter.put('/update-category/:id',auth,upload.array('categoryImage'),updateCategoryController) 
categoryRouter.put('/update-category/:id',auth,authorizeRoles('ADMIN'),updateCategoryController) 
categoryRouter.put('/update-sub-category/:id',auth,authorizeRoles('ADMIN'),updateSubCategoryController) 
